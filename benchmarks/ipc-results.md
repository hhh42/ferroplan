# ferroplan vendored-corpus raw results

Generated by `benchmarks/run.py` (see `benchmarks/results.md` for the curated oracle comparison).

166 problems, timeout 30s. Plans externally validated with VAL.
