...
timeout 60s/instance, jobs 2, mode auto. Plans externally validated with VAL. STITCHED: 292 row(s) reused from a prior pass's clean windows (ipc5-prop.prior.jsonl).
