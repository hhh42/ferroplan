...
| constraints (re-entered at 0.22) | 5/120 (4.2%) — mostly engine-reject on timed modal operators, not search failure | thin field, 3 officially-scored domains (80 instances): SGPlan5 47/80 (58.8%), MIPS-XXL 13/80 (16.3%) | **last of 3** — well behind even the weaker entrant; the honest floor of a feature gap, not a tuning gap | low |
