...
**59% coverage across 32 IPC boards** (4,988/8,444) on `m5-air`, including **685 certified optima**.

| track | coverage | |
|---|---|---|
| net-benefit | 267/270 | `████████████████` 99% |
| seq-sat | 526/580 | `███████████████░` 91% |
| seq-mco t8 | 248/280 | `██████████████░░` 89% |
| seq-mco t4 | 244/280 | `██████████████░░` 87% |
| seq-mco t2 | 241/280 | `██████████████░░` 86% |
...
> Status: **v0.26.0** — `ferroplan`, `ferroplan-cli`, `ferroplan-mcp` and `ferroplan-sat` are on [crates.io](https://crates.io/crates/ferroplan). APIs may shift before 1.0.
