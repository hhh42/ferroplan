...
**48% coverage across 12 IPC boards** (1,917/4,016) on `m5-air`, including **306 certified optima**.

| track | coverage | |
|---|---|---|
| seq-sat | 473/580 | `█████████████░░░` 82% |
| tempo-sat | 419/630 | `███████████░░░░░` 67% |
| 2023 numeric | 194/400 | `████████░░░░░░░░` 48% |
...
> Status: **v0.20.0** — `ferroplan`, `ferroplan-cli` and `ferroplan-mcp` are on [crates.io](https://crates.io/crates/ferroplan). APIs may shift before 1.0.
