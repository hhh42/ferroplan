...
**58% coverage across 16 IPC boards** (2,867/4,916) on `m5-air`, including **373 certified optima**.

| track | coverage | |
|---|---|---|
| net-benefit | 248/270 | `███████████████░` 92% |
| seq-sat | 504/580 | `██████████████░░` 87% |
| propositional | 366/450 | `█████████████░░░` 81% |
| tempo-sat | 419/630 | `███████████░░░░░` 67% |
| 2023 numeric | 251/400 | `██████████░░░░░░` 63% |
...
> Status: **v0.22.0** — `ferroplan`, `ferroplan-cli` and `ferroplan-mcp` are on [crates.io](https://crates.io/crates/ferroplan). APIs may shift before 1.0.
